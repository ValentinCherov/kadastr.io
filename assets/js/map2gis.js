...
!function() {
    ...
    function i(o, t) {
        ...
        return protocol + "//widgets.2gis.com/widget?type=" + o + "&options=" + encodeURIComponent(JSON.stringify(t));
    }
...
function r(o) {
    ...
    var iframeCode = '<iframe frameborder="no" style="border: ' + borderStyle + '; box-sizing: border-box;" width="' + o.width + '" height="' + o.height + '" src="' + o.src + '"></iframe>';
    ...
    var responsiveIframeCode =
        ...
        '   ' + 'iframe {' +
        '       width: 100%;' + // Ширина 100% на устройствах с шириной экрана до 767px
        '   }' +
        '}' +
        '@media screen and (min-width: 768px) {' +
        '   ' + 'iframe {' +
        '       width: ' + o.width + 'px;' + // Вернуть оригинальную ширину на устройствах с шириной экрана 768px и более
        '   }' +
        '}' +
        '</style>' +
        iframeCode;
    ...
    window.DGWidgetLoader = function(n) {
        ...
        document.write(r({ width: e, height: d, borderColor: n.borderColor || "#a3a3a3", src: i("firmsonmap", p) }));
    };
    ...
    DG.Widget.Components.Loader = function(t) {
        ...
        var n, e, d = 500, s = 400, a = t.resize;
        if (a) {
